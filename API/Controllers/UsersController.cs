...
//     {
//         var user = await userRepo.(username);
...
//     {
//         var users = await empRepo.GetAllAsync();
...
//     [HttpPatch("employees/{username}")]
//     public async Task<ActionResult<UserDto>> EditUserInfo([FromBody]UpdateEmployeeDto empData, string username){
//         var employee = await empRepo.GetEmployeeByUsername(username);
//         if(employee == null){
